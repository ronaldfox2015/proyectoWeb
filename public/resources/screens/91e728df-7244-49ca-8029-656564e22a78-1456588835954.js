jQuery("#simulation")
  .on("click", ".s-91e728df-7244-49ca-8029-656564e22a78 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Text_72")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("mouseenter dragenter", ".s-91e728df-7244-49ca-8029-656564e22a78 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-91e728df-7244-49ca-8029-656564e22a78 #s-Line_11": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-91e728df-7244-49ca-8029-656564e22a78 #s-Line_10": {
                      "attributes": {
                        "border-top-width": "2px",
                        "border-top-style": "solid",
                        "border-top-color": "#05AADD",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-91e728df-7244-49ca-8029-656564e22a78 #s-Line_12": {
                      "attributes": {
                        "border-top-width": "2px",
                        "border-top-style": "solid",
                        "border-top-color": "#05AADD",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-91e728df-7244-49ca-8029-656564e22a78 #s-Line_9": {
                      "attributes": {
                        "border-top-width": "2px",
                        "border-top-style": "solid",
                        "border-top-color": "#05AADD",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-91e728df-7244-49ca-8029-656564e22a78 #s-Line_13": {
                      "attributes": {
                        "border-top-width": "2px",
                        "border-top-style": "solid",
  ...
  .on("mouseleave dragleave", ".s-91e728df-7244-49ca-8029-656564e22a78 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
