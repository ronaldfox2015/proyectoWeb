jQuery("#simulation")
  .on("click", ".s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("mouseenter dragenter", ".s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619 #s-Line_11": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619 #s-Line_10": {
                      "attributes": {
                        "border-top-width": "2px",
                        "border-top-style": "solid",
                        "border-top-color": "#05AADD",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619 #s-Line_12": {
                      "attributes": {
                        "border-top-width": "2px",
                        "border-top-style": "solid",
                        "border-top-color": "#05AADD",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619 #s-Line_8": {
                      "attributes": {
                        "border-top-width": "2px",
                        "border-top-style": "solid",
                        "border-top-color": "#05AADD",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619 #s-Line_9": {
                      "attributes": {
                        "border-top-width": "2px",
                        "border-top-style": "solid",
                        "border-top-color": "#05AADD",
  ...
  .on("mouseleave dragleave", ".s-f8a1a0de-0b67-42c6-9258-5fbf5b0a8619 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
