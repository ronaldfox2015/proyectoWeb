...
var PositEPass = (function () {
	function PositEPass() {
        ...
        $( ".posit-Epass-MisSaldos" ).hover(function() {
            $( this ).find(".posit-Epass-titulo").addClass( "animationHoverLetra" );
            $( this ).find(".fa-angle-right").addClass( "animationHoverLetra" );
            $( this ).find(".fa-angle-left").addClass( "animationHoverLetra" );
            $( this ).find(".fa-refresh").addClass( "animationHoverLetra" );
            $( this ).find(".fa-credit-card").addClass( "animationHoverLetra" );
            $( this ).find(".fa-hand-o-up").addClass( "animationHoverLetra" );
        }, function() {
            $( this ).find(".posit-Epass-titulo").removeClass( "animationHoverLetra" );
            $( this ).find(".fa-angle-right").removeClass( "animationHoverLetra" );
            $( this ).find(".fa-angle-left").removeClass( "animationHoverLetra" );
            $( this ).find(".fa-refresh").removeClass( "animationHoverLetra" );
            $( this ).find(".fa-credit-card").removeClass( "animationHoverLetra" );
            $( this ).find(".fa-hand-o-up").removeClass( "animationHoverLetra" );    
          })
	}
	...
	_createClass(PositEPass, [{
		...
		value: function ocultarPositEpass() {
            ...
            $(".posit-Epass-Container").css("width","2em");
		}
	}, {
		...
		value: function mostrarPositEpass() {
            ...
            $(".posit-Epass-Container").css("width","8em");
		}
	}]);
...
function inicio()
{
    var consultas = new PositEPass();
    power2Library();
    activarPower2();
    $(".link_persona").on("click",abrirPersona);
    $(".link_empresa").on("click",abrirEmpresa);
    $(".link_recarga_personas").on("click",abrirRecargaPersonas);
    $(".link_recarga_empresas").on("click",abrirRecargaEmpresas);
}
function abrirRecargaEmpresas()
{
    location.href="/recarga-empresas";
}
function abrirRecargaPersonas()
{
    location.href="/recarga-personas";
}
